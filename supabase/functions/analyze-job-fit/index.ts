// Recalculate score with focused framework and identify weak experiences
      if (analysis.jobRequirements && analysisimport "https://deno.land/x/xhr@0.1.0/mod.ts";
...
const SCORING_CONFIG = {
  ...
  PROGRESSION_BONUS: {
    accelerated: 1.2,  // Fast career growth
    steady: 1.0,       // Normal progression
    lateral: 0.8,      // Horizontal movement
    stagnant: 0.6      // Limited growth
  },
  FIT_THRESHOLDS: {
    excellent: 90,
    strong: 75,
...
Focus on 4 key areas that predict job performance:

1. **TECHNICAL SKILLS (40%)**: Programming languages, tools, frameworks, methodologies
   - Can they use the required technologies?
   - Do they have the technical depth needed?

2. **EXPERIENCE LEVEL (30%)**: Role complexity, responsibility scope, similar challenges
...
4. **BEHAVIORAL FIT (10%)**: Demonstrated behaviors that match job requirements
   - Look for evidence of: collaboration, problem-solving, initiative, communication
...
Return JSON:
{
  "jobRequirements": [
    {
      ...
      "category": "technical|experience_level|domain_industry|behavioral_fit",
  ...
  "fitAssessment": {
    ...
    "categoryBreakdown": {
      ...
      "behavioral_fit": {"score": 85, "confidence": "high|medium|low"}
    }
  },
